    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
            <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="index.php"><?php echo ucwords($_SESSION['dept_name']). ' Home';?><span class="sr-only">(current)</span></a></li>
                <li class=""><a href="about.php"><?php echo ucwords($_SESSION['dept_name']). ' About';?><span class="sr-only">(current)</span></a></li>
                <li class="dropdown">
